...
namespace sp23Team13FinalProject.Utilities
{
    public static class EmailMessaging
    {
        public static void SendEmail(String emailSubject, String emailBody, String? srecipient, String? rrecipient)
        {
            ...
            String strFromEmailAddress = "sp23team13@gmail.com";
            ...
            String strPassword = "taoqvwvijwcbiklv";

            //This is the name of the business from which you are sending
            String strCompanyName = "Bevo Recruiting";
            ...
            mm.To.Add(new MailAddress("sp23team13@gmail.com"));
            mm.To.Add(new MailAddress(srecipient));
            mm.To.Add(new MailAddress(rrecipient));
            //if (recipient == null)
            //{
            //    mm.To.Add(new MailAddress("sp23team13@gmail.com"));
            //}
