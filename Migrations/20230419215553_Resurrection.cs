...
{
    /// <inheritdoc />
    public partial class Resurrection : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Industry1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Industry2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Industry3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Positions_Companies_CompaniesCompanyID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ApplicableMajorsMajorID = table.Column<int>(type: "int", nullable: false),
                    PositionsPositionID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MajorPosition", x => new { x.ApplicableMajorsMajorID, x.PositionsPositionID });
                    table.ForeignKey(
                        name: "FK_MajorPosition_Majors_ApplicableMajorsMajorID",
                        column: x => x.ApplicableMajorsMajorID,
                        principalTable: "Majors",
                        principalColumn: "MajorID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterviewScheduled = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyEndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    InterviewAvailable = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Positions_CompaniesCompanyID",
                table: "Positions",
